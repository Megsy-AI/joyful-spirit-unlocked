...
const PLANS: PlanCardConfig[] = [
  ...
  },
  {
    ...
    features: [
      "Claude Sonnet 4 & Opus 4 — Unlimited & Free",
      "Unlimited chat — Megsy Lite, Pro & Max",
      "Unlimited image generation (Megsy Image included)",
      "Slides, Docs, Deep Research & Code Builder — unlimited 7 days / month",
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited chat — Megsy Lite, Pro & Max",
      "Unlimited image generation (Megsy Image included)",
      "Megsy Video — unlimited",
      "Slides, Docs, Deep Research & Code Builder — unlimited 15 days / month",
      "Megsy OS autonomous tasks — unlimited",
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited image generation (Megsy Image included)",
      "Megsy Video — unlimited",
      "Slides, Docs, Deep Research & Code Builder — unlimited all month",
      "Megsy OS autonomous tasks — unlimited",
