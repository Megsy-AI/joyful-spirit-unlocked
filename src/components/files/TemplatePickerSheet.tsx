              ...
              <div className="grid grid-cols-2 gap-4 max-w-3xl mx-auto">
                {visible.map((t) => {
                  ...
                  return (
                    ...
                    >
                      <div className="relative w-full aspect-video overflow-hidden" style={fallbackStyle(t)}>
                        {t.preview && <img src={t.preview} alt="" loading="lazy" className="absolute inset-0 w-full h-full object-contain" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />}
                        {active && (
