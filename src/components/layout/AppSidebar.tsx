...
import { Pin, Plus, PanelLeft, LogIn } from "lucide-react";
        ...
        {!currentUserId ? (
          isCollapsed ? (
            <div className="flex flex-col items-center gap-1.5">
              <button
                onClick={() => { navigate("/auth"); onClose(); closeInline(); }}
                ...
                aria-label="Log in"
              >
                <LogIn className="w-[18px] h-[18px]" strokeWidth={2.2} />
              </button>
            </div>
          ) : (
            <button
              onClick={() => { navigate("/auth"); onClose(); closeInline(); }}
              className="w-full h-10 px-3 flex items-center justify-center gap-2 rounded-xl text-[13.5px] font-medium text-primary bg-primary/10 hover:bg-primary/15 border border-primary/20 transition-colors"
            >
        ...
        <div className="pointer-events-auto flex items-center gap-2">
          {!currentUserId ? (
            <button
              ...
              className="flex-1 h-11 flex items-center justify-center gap-2 rounded-full text-[14px] font-medium text-primary bg-primary/10 hover:bg-primary/15 border border-primary/20 transition-colors"
            >
              <LogIn className="w-4 h-4" strokeWidth={2.2} />
              <span>Log in</span>
            </button>
